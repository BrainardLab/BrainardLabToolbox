...
% Provides an interface to communicate with LabJack UE9 DIO/DAQ devices
% 
...
classdef LabJack < handle
    ...
    methods
        % Constructor
        function self = LabJack(varargin)
    ...
    methods (Access = private)
        ...
        function status = sendLowLevelCommand(self, dataMessage)
            ...
            if (self.deviceProductID == LabJack.U6)
