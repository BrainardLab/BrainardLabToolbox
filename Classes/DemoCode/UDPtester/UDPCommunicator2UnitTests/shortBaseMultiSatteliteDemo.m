...
%
function packetSequence = designPacketSequenceForSattelite1(UDPobj, satteliteHostName, timeOutSecs, coeffPoints)
...
%
function packetSequence = designPacketSequenceForSattelite2(UDPobj, satteliteHostName, timeOutSecs, coeffPoints)
    % Define the communication  packetSequence
    packetSequence = {};
