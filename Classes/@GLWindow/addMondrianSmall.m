function addMondrianSmall(GLWObj, numRows, numColumns, dimensions, colors, varargin)
...
switch obj.Type
	...
	% The horizontal shift amount is the width of two columns.
	shiftAmount = obj.Verts(1,3,1) - obj.Verts(1,1,1);
	
	offset = 0;
			offset = offset + shiftAmount;

		
		obj.Verts(3,:,1) = obj.Verts(3,:,1) + offset;
		obj.Verts(4,:,1) = obj.Verts(3,:,1);
	...
	offset = 0;
		...
		obj.Verts(4,:,1) = obj.Verts(4,:,1) + offset;
