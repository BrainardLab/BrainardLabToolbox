function CompareSquareMeas
% CompareSquareMeas
%
% Compare the three measurements of the square for a given date.
%
...
radiometerChecksDir = '/home/colorlab/Aguirre-Brainard Lab Dropbox/Metropsis Experimenter/MELA_admin/RadiometerChecks';
...
if (exist(['NewUCSB_Square_' dateStr '.mat'],'file'))
    fprintf('Loading NewUCSB PR-650 data\n');
    newMeterData = load(['NewUCSB_Square_' dateStr],'wls','theSpectra');
...
if (exist(['Penn_Square_' dateStr '.mat'],'file'))
    fprintf('Loading Penn PR-650 data\n');
    pennMeterData = load(['Penn_Square_' dateStr],'wls','theSpectra');
...
if (exist(['PR-670_1_Square_' dateStr '.mat'],'file')) 
    fprintf('Loading PR-670_1 data\n');
    pr670_1_MeterData = load(['PR-670_1_Square_' dateStr],'wls','theSpectra');
...
if (exist(['PR-670_2_Square_' dateStr '.mat'],'file')) 
    fprintf('Loading PR-670_2 data\n');
    pr670_2_MeterData = load(['PR-670_2_Square_' dateStr],'wls','theSpectra');
...
xlim([300 800]);
exportgraphics(gcf, fullfile(radiometerChecksDir,'xComparison',['PRComparison_Relative_' dateStr '.pdf']), 'ContentType', 'vector');
...
legend(legendStr,'Location','NorthWest','FontSize',14);
xlim([300 800]);
exportgraphics(gcf, fullfile(radiometerChecksDir,'xComparison',['PRComparison_Absolute_' dateStr '.pdf']), 'ContentType', 'vector');
