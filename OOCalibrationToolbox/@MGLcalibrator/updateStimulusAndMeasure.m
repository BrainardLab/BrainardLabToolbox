...
%
    ...
    S           = [obj.radiometerObj.measurement.spectralAxis(1), ...
                   obj.radiometerObj.measurement.spectralAxis(2)-obj.radiometerObj.measurement.spectralAxis(1),...
                   length(obj.radiometerObj.measurement.spectralAxis) ...
                   ];
end