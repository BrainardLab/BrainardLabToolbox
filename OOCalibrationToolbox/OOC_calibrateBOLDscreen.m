...
function OOC_calibrateMonitor
    ...
    calibratorInitParams = { ...
        ...
        'displayDeviceName',        'BOLDScreen', ...     % a name for the display, could be anything
        'calibrationFile',          'BOLDScreen', ...       % name of file on which the calibration data will be saved
        'comment',                  'BOLDScreen' ...      % a comment, could be anything
        };
    ...
    calibratorOptions = CalibratorOptions( ...
        ...
        'emailAddressForDoneNotification',  GetWithDefault('Enter email address for done notification',  'mspits@sas.upenn.edu'), ...
