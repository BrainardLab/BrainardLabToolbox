function OOC_spatialCalibrationSonyOLED
    ...
    % Calibration file
    calibrationFileName = '/Users/Shared/Matlab/Toolboxes/BrainardLabToolbox/OOCalibrationToolbox/SonyOLED_CloudsCalib10.mat';
    ...
    runParams = struct(...
            ...
            'comment',              'First spatial calibration of SONY.' ...
        );
    ...
    try
        if (runMode)
            ...
            calibratorOBJ = SonyOLEDCalibrator(...
