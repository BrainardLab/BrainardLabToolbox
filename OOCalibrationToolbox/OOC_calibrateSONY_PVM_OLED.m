...
function OOC_calibrateSONY_PVM_OLED
    ...
    calibratorInitParams = { ...
        ...
        'displayDeviceName',        'Right_SONY_PVM_OLED', ...     % a name for the display, could be anything
        'calibrationFile',          'Right_SONY_PVM_OLED', ...       % name of file on which the calibration data will be saved
        'comment',                  'The right display of the stereo HDR Rig - calibrated via the Samsung setting' ...      % a comment, could be anything
        };
