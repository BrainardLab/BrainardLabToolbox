function ColorMaterialModelPlotFit(theDataProb, predictedProbabilitiesBasedOnSolution, ...
...
if weibullplots
    ...
    thisFig1 = ColorMaterialModelPlotWeibullFit(theSmoothVals, theSmoothPreds, params.colorMatchMaterialCoords, theDataProb, 'colorMatch');
    thisFig2 = ColorMaterialModelPlotWeibullFit(theSmoothValsReverseModel, theSmoothPredsReverseModel, params.materialMatchColorCoords, 1-theDataProb', 'materialMatch');
...
thisFig3 = ColorMaterialModelPlotMLDSFit(returnedW, rangeOfMaterialMatchColorCoordinates, modelPredictions, params.materialMatchColorCoords, theDataProb, 'colorMatch', ...
...
thisFig4 = ColorMaterialModelPlotMLDSFit(returnedW, rangeOfColorMatchMaterialCoordinates, modelPredictions2, params.colorMatchMaterialCoords, 1-theDataProb', 'materialMatch', ...
