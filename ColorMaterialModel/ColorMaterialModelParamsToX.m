function [x] = ColorMaterialModelParamsToX(colorMatchMaterialCoords,materialMatchColorCoords,w,sigma,params)
% [x] = ColorMaterialModelParamsToX(colorMatchMaterialCoords,materialMatchColorCoords,w,sigma,params)
%
