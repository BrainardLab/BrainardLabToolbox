...
if (DEMO)
    ...
    for whichWithinColorPair = 1:size(withinCategoryPairsColor,1)
        % targetMaterialCoord;
        pair = [pair; ...
            {[withinCategoryPairsColor(whichWithinColorPair, 1), targetMaterialCoord]}, {[withinCategoryPairsColor(whichWithinColorPair, 2), targetMaterialCoord]}];
    end
    
    for whichWithinMaterialPair = 1:size(withinCategoryPairsMaterial,1)
        pair = [pair; ...
            {[targetColorCoord, withinCategoryPairsMaterial(whichWithinMaterialPair, 1)]}, {[targetColorCoord, withinCategoryPairsMaterial(whichWithinMaterialPair, 2)]}]; 
    end
