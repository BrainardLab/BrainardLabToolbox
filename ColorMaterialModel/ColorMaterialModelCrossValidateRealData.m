        ...
        for kk = 1:c.NumTestSets
            ...
            for whichModelType = 1:nModelTypes
                if whichModelType == 1
                    ...
                    tryColorSpacingValues = params.trySpacingValues;
                    tryMaterialSpacingValues = params.trySpacingValues;
                    tryWeightValues = params.tryWeightValues;
                elseif whichModelType == 2
                    params.whichWeight = whichWeight;
                    params.whichPositions = 'smoothSpacing';
                    params.smoothOrder = 3;
                    tryColorSpacingValues = [params.trySpacingValues linearSolutionColorSlope];
                    tryMaterialSpacingValues = [params.trySpacingValues linearSolutionMaterialSlope];
                    tryWeightValues = [params.tryWeightValues linearSolutionWeight]; 
                ...
                [thisSubject.condition{whichCondition}.crossVal(whichModelType).returnedParamsTraining(kk,:), ...
                    ...
                    'tryWeightValues',params.tryWeightValues,'tryColorSpacingValues',params.tryColorSpacingValues,'tryMaterualSpacingValues',params.tryMaterialSpacingValues, ...
                ...
                if (whichModelType == 1)
                    ...
                    linearSolutionColorSlope = linearSolutionParameters(1);
                    linearSolutionMaterialSlope = linearSolutionParameters(2);
