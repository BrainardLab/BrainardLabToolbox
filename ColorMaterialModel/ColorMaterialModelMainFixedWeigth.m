function [x, logLikelyFit, predictedResponses, k] = ColorMaterialModelMainFixedWeigth(pairColorMatchMatrialCoordIndices,pairMaterialMatchColorCoordIndices,theResponses,nTrials, params)
% function [x, logLikelyFit, predictedResponses] = ColorMaterialModelMainFixedWeigth(pairColorMatchMatrialCoordIndices,pairMaterialMatchColorCoordIndices,theResponses,nTrials, params)
...
for k1 = 1:length(trySpacing)
    for k2 = 1:length(trySpacing)
        for k3 = 1:size(tryWeights)
            ...
            vlb(end-1) = 0.5; % fix weight to 0.5 
            vub(end-1) = 0.5; 
