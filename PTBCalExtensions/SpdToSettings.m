...
for i = 1:numSpectra
	...
	primaries(:,i) = OLSpdToPrimary(calOrCalStruct, targetSpds(:,i), 'lambda',params.lambda, 'verbose', params.verbose);
    
    % Convert to spectra
    predictedSpds(:,i) = OLPrimaryToSpd(calOrCalStruct,primaries(:,i));
end
