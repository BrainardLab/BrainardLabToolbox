function DrawMondrianHDRStimulus(cal, centerRGB)
% DrawMondrianHDRStimulus(cal, centerRGB)
%
% Description:
% Draws the Mondrian surround plus center color that we need to measure in
% the Mondrian HDR calibration script.

% 7/12/2010 cgb     Pulled it out from HDRAna code. 

global GL;

% Set the center square color.
cal.mondrian.surroundColors(3,3,:) = centerRGB;
